...
public class PortfoliosContributionsRunner extends AbstractContributionsRunner {
	...
	public PortfoliosContributionsRunner(Date startDate, Date endDate, EIMCompanies eimCompany, String connectionSource) {
		super();
	...
	public ArrayList<Long> getEntitiesWorkingSet() {
		...
		try {
			PreparedStatement prepareStatement = connection.prepareStatement(QueriesProvider.getQuery("PORTFOLIOS_LIST.SQL"));
			...
			log.error("A SQL error occured during Portfolio workset creation!", e);
		}
		return workingSet;
	}
