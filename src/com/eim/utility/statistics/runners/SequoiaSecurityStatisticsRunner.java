 ...
 *
 */
public class SequoiaSecurityStatisticsRunner extends AbstractStatisticsRunner {

	public SequoiaSecurityStatisticsRunner(ComputationFrequency frequency) {
		this.entityType = EntityType.TOP_LEVEL_FUND;
	...
	public ArrayList<String> getEntitiesWorkingSet() {
		...
		try {
			PreparedStatement prepareStatement = connection.prepareStatement(QueriesProvider.getQuery("SEQUOIA_SECURITIES_LIST.SQL"));
