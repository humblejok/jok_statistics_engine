...
public class SequoiaPortfolioTrackContentExtractor extends TrackContentExtractor {
	...
	public String getAllPerformancesQueryName() {
		return "SEQUOIA_PORTFOLIO_PERFORMANCES.SQL";
	}

	@Override
	public String getRangePerformancesQueryName() {
		return "SEQUOIA_PORTFOLIO_PERFORMANCES_WITHIN_RANGE.SQL";
	}
