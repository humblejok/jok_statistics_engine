...
public class SequoiaSecurityTrackContentExtractor extends TrackContentExtractor {
	...
	public String getAllPerformancesQueryName() {
		return "SEQUOIA_SECURITY_PERFORMANCES.SQL";
	}

	@Override
	public String getRangePerformancesQueryName() {
		return "SEQUOIA_SECURITY_PERFORMANCES_WITHIN_RANGE.SQL";
	}
